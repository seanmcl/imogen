...
structure List1 = struct
   ...
   fun unzip3 abcList =
      let
         fun unzip3Loop [] (aa,bb,cc) = (rev aa, rev bb, rev cc)
           | unzip3Loop ((a,b,c)::rest) (aa,bb,cc) = unzip3Loop rest (a::aa,b::bb,c::cc)
      in unzip3Loop abcList ([],[],[]) end
   ...
   fun unzip4 abcdList =
      let
         fun unzip4Loop [] (aa,bb,cc,dd) = (rev aa, rev bb, rev cc, rev dd)
           | unzip4Loop ((a,b,c,d)::rest) (aa,bb,cc,dd) = unzip4Loop rest (a::aa,b::bb,c::cc,d::dd)
      in unzip4Loop abcdList ([],[],[],[]) end
   ...
   in
      fun toString p = bracket o scommas o map p
   end
...
*)
   ...
   (* findMap = Option.map f (List.find (isSome o f) l) *)
   fun findMap f = fn
      [] => NONE
    | h::t =>
      case f h of
   ...
   *)
   ...
   fun allInjectiveMaps l = allInjectiveMapsBy SOME l
